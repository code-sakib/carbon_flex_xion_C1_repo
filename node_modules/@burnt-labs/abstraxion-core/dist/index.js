...
var query = require('cosmjs-types/cosmos/authz/v1beta1/query');
var base64Js = require('base64-js');
var authz$4 = require('cosmjs-types/cosmos/authz/v1beta1/authz');
var authz$1 = require('cosmjs-types/cosmos/staking/v1beta1/authz');
var authz$3 = require('cosmjs-types/cosmos/bank/v1beta1/authz');
var authz$2 = require('cosmjs-types/ibc/applications/transfer/v1/authz');
var authz = require('cosmjs-types/cosmwasm/wasm/v1/authz');
...
var getRpcClient = async (endpoint) => {
  ...
  const rpcClient = useHttp ? new tendermintRpc.HttpClient(endpoint) : new tendermintRpc.WebsocketClient(
    typeof endpoint === "string" ? endpoint : endpoint.url
  );
  return tendermintRpc.Comet38Client.create(rpcClient);
};
...
var GranteeSignerClient = class extends cosmwasmStargate.SigningCosmWasmClient {
  ...
  async simulate(signerAddress, messages, memo, feeGranter) {
    ...
    const authInfo = tx$1.AuthInfo.fromPartial({
      fee: tx$1.Fee.fromPartial({ granter: feeGranter }),
      signerInfos: [
        {
          publicKey: protoSigning.encodePubkey(pubkey),
          modeInfo: {
            single: {
...
var SignArbSecp256k1HdWallet = class {
  ...
  signArb = async (signerAddress, message) => {
    ...
    const serializedSignDoc = amino.serializeSignDoc(signDoc);
    const digest = new crypto.Sha256(serializedSignDoc).digest();
    const signature = await crypto.Secp256k1.createSignature(digest, privkey);
...
var fetchChainGrantsABCI = async (grantee, granter, rpcUrl) => {
  ...
  try {
    ...
    const queryClient = new stargate.QueryClient(rpcClient);
    const protobufRpcClient = stargate.createProtobufRpcClient(queryClient);
    const authzClient = new query.QueryClientImpl(protobufRpcClient);
...
var decodeAuthorization = (typeUrl, value) => {
  const processedAuthorizationValue = typeof value === "string" ? base64Js.toByteArray(value) : value;
  switch (typeUrl) {
    case "/cosmos.authz.v1beta1.GenericAuthorization" /* Generic */:
      return {
        type: "/cosmos.authz.v1beta1.GenericAuthorization" /* Generic */,
        data: authz$4.GenericAuthorization.decode(processedAuthorizationValue)
      };
    case "/cosmos.bank.v1beta1.SendAuthorization" /* Send */:
      return {
        type: "/cosmos.bank.v1beta1.SendAuthorization" /* Send */,
        data: authz$3.SendAuthorization.decode(processedAuthorizationValue)
      };
    case "/ibc.applications.transfer.v1.TransferAuthorization" /* IbcTransfer */:
      return {
        ...
        data: authz$2.TransferAuthorization.decode(processedAuthorizationValue)
      };
    case "/cosmos.staking.v1beta1.StakeAuthorization" /* Stake */:
      return {
        type: "/cosmos.staking.v1beta1.StakeAuthorization" /* Stake */,
        data: authz$1.StakeAuthorization.decode(processedAuthorizationValue)
      };
    case "/cosmwasm.wasm.v1.ContractExecutionAuthorization" /* ContractExecution */: {
      const authorization = authz.ContractExecutionAuthorization.decode(
        ...
        if (grant.limit) {
          switch (grant.limit.typeUrl) {
            case "/cosmwasm.wasm.v1.MaxCallsLimit" /* MaxCalls */:
              ...
              maxCalls = authz.MaxCallsLimit.decode(
                grant.limit.value
              ).remaining.toString();
              break;
            case "/cosmwasm.wasm.v1.MaxFundsLimit" /* MaxFunds */:
              limitType = "/cosmwasm.wasm.v1.MaxFundsLimit" /* MaxFunds */;
              maxFunds = authz.MaxFundsLimit.decode(grant.limit.value).amounts;
              break;
            case "/cosmwasm.wasm.v1.CombinedLimit" /* CombinedLimit */: {
              const combined = authz.CombinedLimit.decode(grant.limit.value);
        ...
        if (grant.filter) {
          switch (grant.filter.typeUrl) {
            case "/cosmwasm.wasm.v1.AcceptedMessageKeysFilter" /* AcceptedKeys */:
              ...
              keys = authz.AcceptedMessageKeysFilter.decode(grant.filter.value).keys;
              break;
            case "/cosmwasm.wasm.v1.AcceptedMessagesFilter" /* AcceptedMessages */:
              ...
              messages = authz.AcceptedMessagesFilter.decode(
                grant.filter.value
              ).messages;
              break;
...
var AbstraxionAuth = class {
  ...
  async getCosmWasmClient() {
    try {
      ...
      const cosmwasmClient = await cosmwasmStargate.CosmWasmClient.connect(this.rpcUrl || "");
...
exports.ContractExecFilterTypes = ContractExecFilterTypes;
exports.ContractExecLimitTypes = ContractExecLimitTypes;
exports.GranteeSignerClient = GranteeSignerClient;
exports.SignArbSecp256k1HdWallet = SignArbSecp256k1HdWallet;
exports.compareBankGrants = compareBankGrants;
exports.compareChainGrantsToTreasuryGrants = compareChainGrantsToTreasuryGrants;
exports.compareContractGrants = compareContractGrants;
exports.compareStakeGrants = compareStakeGrants;
exports.decodeAuthorization = decodeAuthorization;
exports.fetchChainGrantsABCI = fetchChainGrantsABCI;
exports.formatCoinArray = formatCoinArray;
exports.getTreasuryContractConfigsByTypeUrl = getTreasuryContractConfigsByTypeUrl;
exports.getTreasuryContractTypeUrls = getTreasuryContractTypeUrls;
exports.isLimitValid = isLimitValid;
exports.parseCoinString = parseCoinString;
exports.validateContractExecution = validateContractExecution;
